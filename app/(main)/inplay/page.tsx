...
import { TomexchInPlay } from "@/themes/tomexch/exchange/tomexch-inplay";
...
export default function InPlayPage() {
  ...
  // TomExch renders its own in-play view — the same live-odds match sections as
  // its home page, filtered to in-play. The Default/Diamond list view follows.
  if (theme === "tomexch") return <TomexchInPlay />;

  return <DefaultInPlayPage />;
}

function DefaultInPlayPage() {
