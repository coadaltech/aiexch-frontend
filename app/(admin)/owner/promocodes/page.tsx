...
import { useOwnerPromocodes, useUpdatePromocode, useDeletePromocode, useCreatePromocode } from "@/hooks/useOwner";
import { useDebounce } from "@/hooks/useDebounce";
import { useFilters } from "@/hooks/useFilters";
import { useTableSort } from "@/hooks/useTableSort";
import { usePagination } from "@/hooks/usePagination";
import { PromoCodeModal } from "@/components/owner/promocode-modal";
...
export default function PromocodesPage() {
  ...
  const { data: promocodes = [], isLoading, error } = useOwnerPromocodes();
