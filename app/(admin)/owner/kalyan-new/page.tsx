                  ...
                  <div className="flex items-center gap-4 mt-2.5 ml-[60px] text-xs flex-wrap">
                    <div className="flex items-center gap-4 flex-wrap">
                      ...
                      {shift.closingTime && (
                        <div>
                          ...
                          <span className="ml-1.5 text-foreground font-medium">{shift.closingTime}</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      <div>
                        ...
                        <span className="ml-1.5 text-foreground font-medium">{shift.singlePanaRate}</span>
                        <span className="text-muted-foreground ml-0.5">({shift.singlePanaCommission}%)</span>
                      </div>
                      <div>
                        <span className="text-muted-foreground">DP</span>
                        <span className="ml-1.5 text-foreground font-medium">{shift.doublePanaRate}</span>
                        <span className="text-muted-foreground ml-0.5">({shift.doublePanaCommission}%)</span>
                      </div>
                      <div>
                      ...
                      <div>
                        <span className="text-muted-foreground">Sangam</span>
                        <span className="ml-1.5 text-foreground font-medium">{shift.sangamRate}</span>
                        <span className="text-muted-foreground ml-0.5">({shift.sangamCommission}%)</span>
                      </div>
