          ...
          {leftMenu.map((item, index) => {
            ...
            return (
              <button
                ...
                className={cn(`group relative px-3 sm:px-4 py-2 sm:py-2.5 text-xs md:text-[16px] font-medium transition-all duration-150 flex items-center gap-1 touch-manipulation flex-shrink-0 cursor-pointer border-b-2 rounded-t-lg ${active
